...
function endGame(reason) {
  ...
  div.innerHTML = `
    ...
    <div class="gameover-source">learned from &ldquo;Problem Solving with Abstraction&rdquo; by Programming 2.0 ( <a href="https://youtu.be/eyx25adnN6A?si=u5WIiZWgkfgUVVrG" target="_blank" style="color: var(--neon-cyan); text-decoration: none; pointer-events: auto; position: relative; z-index: 10;">YouTube</a> )</div>
