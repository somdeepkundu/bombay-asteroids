# Bombay Asteroids — Detailed Documentation
...
├── script.js                # Game logic, leaderboard, audio
├── style.css                # Neon arcade styles, mobile layout
├── manifest.json            # PWA manifest
├── sw.js                    # Service worker (offline cache)
├── dashboard.html           # Public-facing dashboard alias
├── README.md                # Quick start guide
├── DETAILED.md              # Full documentation (this file)
├── LEADERBOARD_SETUP.md
├── backend/
│   ├── app.py               # Flask API (Firestore)
│   ├── requirements.txt
│   ├── Dockerfile
│   └── README.md
├── admin/
│   └── dashboard.html       # Analytics dashboard (local, key-protected)
└── assets/graphics/
    ├── spaceship_full.svg
...
| v2.1.2 LTR | Map tile provider fix — switched to OpenTopoMap (no API key), improved HUD/FIRE button visibility |
